            ...
            <div className="row">
              {
                productsToShow.map((itemValue, index) => (
                  <div className='col-lg-3 col-md-4 col-sm-6 col-6  text-center cursor-pointer  ' key={index}>
                    ...
                    <div className="text-center ps-2 custom-padding">
                      <p className="mb-2 text-uppercase text-dark mt-3 custom-font-size-and-weight px-lg-0 px-3 fw-bold">{itemValue.title}</p>
